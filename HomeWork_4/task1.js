...
users.forEach(element => { element.registrationDate == '09.10.2021' || element.registrationDate == '10.10.2021' ?
    console.log(element.firstName + ' ' + element.lastName) : null    
});

/* const filterData = users.filter(element => element.registrationDate == '09.10.2021' || element.registrationDate == '10.10.2021')
